# Generated by Django 4.2 on 2024-02-15 23:51
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.CharField(choices=[('RUS', 'Россия'), ('ARM', 'Армения'), ('BLR', 'Беларусь'), ('GEO', 'Грузия'), ('CHN', 'Китай')], default='RUS', verbose_name='Страна')),
                ('field_uuid', models.UUIDField(default=uuid.UUID('23b5f8ea-58ce-45bc-a6ae-e8f8fc1924f6'), unique=True, verbose_name='UUID')),
